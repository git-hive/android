...
public class LoginActivity extends AppCompatActivity {
    ...
    private SignInButton mTextViewGoogleSignInButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextViewGoogleSignInButton = findViewById(R.id.text_google_sign_in_button);
        ...
        mTextViewGoogleSignInButton.setOnClickListener(new OnClickListener() {
            @Override
